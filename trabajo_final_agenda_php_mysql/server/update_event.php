...
require_once "conexion.php";
	//$conexion = new mysqli("localhost", "root", "peluche2016", "agenda");
	if ($conexion){
		session_start();
		if ($_SESSION['agendaID']){
			...
			$add_evento = mysqli_query($conexion, "UPDATE agenda SET 
				start= '$fecha_inicio', start_hour='$hora_inicio', end = '$fecha_fin'
				, end_hour='$hora_fin' where id = '$id' ");
			$php_reponse["msg"]="OK";
